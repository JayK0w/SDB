...
| **Outbound alerting** — non-blocking webhook on failed/warning runs. Payload carries no credentials, endpoints or raw restic output. | off | `SDB_ALERT_WEBHOOK`, `SDB_ALERT_TIMEOUT` |
